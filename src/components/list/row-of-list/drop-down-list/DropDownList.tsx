...
const DropDownList: FC<ListProps> = ({ file }) => {
  ...
  return (
    <TableRow className="">
      ...
      <TableCell className="py-3 text-gray-500 text-theme-sm dark:text-gray-400 cursor-pointer">ㅤ</TableCell>
      {/* {flag && <TableCell className="py-3 text-gray-500 text-theme-sm dark:text-gray-400">{file.category}</TableCell>} */}
      <TableCell className="py-3 text-gray-500 text-theme-sm dark:text-gray-400">ㅤ</TableCell>
